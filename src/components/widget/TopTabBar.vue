    ...
    <div class="wxc-tab-page"
        ...
        <div class="tab-title-list"
            ...
            <div class="title-item"
                 ...
                 :style="{ width: tabStyles.width +'px', height: tabStyles.height +'px', backgroundColor: currentPage == index ? tabStyles.activeBgColor : tabStyles.bgColor, borderColor: currentPage == index ? tabStyles.activeTitleColor : tabStyles.bgColor, borderBottomWidth: currentPage == index ? '3px' : '0.2px' }"
                 :accessible="true"
