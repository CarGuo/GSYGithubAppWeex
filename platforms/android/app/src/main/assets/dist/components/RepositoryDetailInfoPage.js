...
exports.SUCCESS = exports.NETWORK_JSON_EXCEPTION = exports.NETWORK_TIMEOUT = exports.NETWORK_ERROR = exports.CONTENT_TYPE_FORM = exports.CONTENT_TYPE_JSON = undefined;
...
var _storageUtils = __webpack_require__(9);
...
//网络错误
var NETWORK_ERROR = exports.NETWORK_ERROR = 1;
//网络超时
var NETWORK_TIMEOUT = exports.NETWORK_TIMEOUT = 2;
//网络返回数据格式化一次
var NETWORK_JSON_EXCEPTION = exports.NETWORK_JSON_EXCEPTION = 3;
...
var HttpManager = function () {
    ...
    _createClass(HttpManager, [{
        key: 'getFetch',
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(url, header, type) {
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                return _context.abrupt('return', this.netFetch(url, 'GET', null, null, header, type));
        ...
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee2(url) {
                ...
                var header = arguments[4];
                var type = arguments[5];
                var isConnected, headers, authorizationCode, requestParams, response, responseJson;
                        ...
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 19:
                                ...
                                if (response.status === 201 && responseJson.token) {
                                    ...
                                    (0, _storageUtils.setCache)(_constant.TOKEN_KEY, this.optionParams.authorizationCode);
                                }
        ...
        value: function clearAuthorization() {
            ...
            (0, _storageUtils.removeCache)(_constant.TOKEN_KEY);
        }
    }, {
                ...
                return _regenerator2.default.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                _context3.next = 2;
                                return (0, _storageUtils.getCache)(_constant.TOKEN_KEY);
                            ...
                            case 2:
                                ...
                                _context3.next = 6;
                                return (0, _storageUtils.getCache)(_constant.USER_BASIC_CODE);

                            case 6:
                                basic = _context3.sent;
                            ...
                            case 10:
                                return _context3.abrupt('return', 'Basic ' + basic);
...
var Config = _interopRequireWildcard(_constant);
...
exports.default = function (longTime) {
    if (!longTime) return "";
    var now = (0, _moment2.default)().toDate().getTime();
    var time = (0, _moment2.default)(longTime).toDate().getTime();
    var delta = now - time;
...
var _zhCn = __webpack_require__(18);
...
_moment2.default.updateLocale('zh-cn', _zhCn2.default);
...
function calcTimer(delta, ori) {
    var res = '';
    var list = Object.keys(calculator).sort(function (a, b) {
        return b - a;
    });
    for (var i = 0, key = list[i]; key; key = list[++i]) {
        if (delta > key) {
            var a = Math.floor(delta / key);
            var b = delta % key;
...
var calculator = (_calculator = {}, _defineProperty(_calculator, year, function (a, b, ori) {
    return (0, _moment2.default)(ori).format('YYYY-MM-DD');
}), _defineProperty(_calculator, week, function (a, b, ori) {
    return (0, _moment2.default)(ori).format('MM-DD HH:mm');
}), _defineProperty(_calculator, day, function (a, b, ori) {
    return a + "天前";
}), _defineProperty(_calculator, hour, function (a, b) {
    return a + "小时之前";
}), _defineProperty(_calculator, min, function (a, b) {
    return a + "分钟之前";
}), _defineProperty(_calculator, second, function (a, b) {
    return "刚刚";
}), _calculator);
...
var _eventUtils = __webpack_require__(374);
...
var getEventReceived = function () {
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 2:
                        url = _address2.default.getEventReceived(userInfo.login) + _address2.default.getPageParams("?", page);
                        _context.next = 5;
                        return _api2.default.netFetch(url);
    ...
    return function getEventReceived() {
        return _ref.apply(this, arguments);
    };
}();
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        url = _address2.default.getEvent(userName) + _address2.default.getPageParams("?", page);
                        _context2.next = 3;
                        return _api2.default.netFetch(url);
                    ...
                    case 3:
                        ...
                        if (res && res.result) {
                            res.data.forEach(function (item) {
                                var newItem = (0, _eventUtils.getActionAndDes)(item);
                                var ex = {
...
var getRepositoryEventDao = function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
        var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
        var userName = arguments[1];
        var repository = arguments[2];
        var url, res;
        return _regenerator2.default.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        url = _address2.default.getReposEvent(userName, repository) + _address2.default.getPageParams("?", page);
                        _context3.next = 3;
                        return _api2.default.netFetch(url);
    ...
    return function getRepositoryEventDao() {
        return _ref3.apply(this, arguments);
    };
}();

exports.default = {
    getEventReceived: getEventReceived,
    getEvent: getEvent,
    getRepositoryEventDao: getRepositoryEventDao
};
...
var _GitHubTrending = __webpack_require__(384);
...
var _htmlUtils = __webpack_require__(379);

var _storageUtils = __webpack_require__(9);

var _timeUtils = __webpack_require__(375);
...
var getTrendDao = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
        var since = arguments[1];
        var languageType = arguments[2];
        var url, res;
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        url = _address2.default.trending(since, languageType);
                        _context.next = 3;
                        return new _GitHubTrending2.default().fetchTrending(url, since, languageType);
 ...
 * 详情的remde数据Html模式数据
 */
var getRepositoryDetailReadmeHtmlDao = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee2(userName, reposName, branch) {
        var url, res, curData;
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        url = _address2.default.readmeFile(userName + '/' + reposName, branch);
                        _context2.next = 3;
                        return _api2.default.netFetch(url, 'GET', null, false, { Accept: 'application/vnd.github.html' }, 'text');
                    ...
                    case 3:
                        ...
                        curData = (0, _htmlUtils.generateHtml)(res.data);
                        return _context2.abrupt('return', {
                            data: curData,
                            result: true
                        });
    ...
    return function getRepositoryDetailReadmeHtmlDao(_x2, _x3, _x4) {
        return _ref2.apply(this, arguments);
    };
}();
 ...
 * 仓库的详情数据
 */
var getRepositoryDetailDao = function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee3(userName, reposName) {
        var url, res, created_at, push_at, createStr, updateStr, infoText, issueRes, netData;
        return _regenerator2.default.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        url = _address2.default.getReposDetail(userName, reposName);
                        _context3.next = 3;
                        return _api2.default.netFetch(url, 'GET', null, false, { Accept: 'application/vnd.github.mercy-preview+json' });
                    ...
                    case 3:
                        ...
                        created_at = (0, _timeUtils2.default)(res.data.created_at);
                        push_at = (0, _timeUtils2.default)(res.data.pushed_at);
                        createStr = res.data.fork === true ? "forked from " + reposName + '\n' : "创建于 " + created_at + " ";
                        updateStr = "最后提交于 " + push_at;
                        infoText = createStr + (push_at ? updateStr : '');
                        ...
                        _context3.next = 15;
                        return getRepositoryIssueStatusDao(userName, reposName);

                    case 15:
                        issueRes = _context3.sent;
                        netData = res.data;
    ...
    return function getRepositoryDetailDao(_x5, _x6) {
        return _ref3.apply(this, arguments);
    };
}();
 ...
 * 获取issue总数
 */
var getRepositoryIssueStatusDao = function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4(userName, repository) {
        var url, res, link, indexStart, indexEnd, count;
        return _regenerator2.default.wrap(function _callee4$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        url = _address2.default.getReposIssue(userName, repository) + "&per_page=1";
                        _context4.next = 3;
                        return _api2.default.netFetch(url, 'GET', null, false, { Accept: 'application/vnd.github.html,application/vnd.github.VERSION.raw' });
                    ...
                    case 3:
                        ...
                        indexStart = link.lastIndexOf("page=") + 5;
                        indexEnd = link.lastIndexOf(">");
                        ...
                        count = link.substring(indexStart, indexEnd);
        ...
        }, _callee4, undefined, [[5, 16]]);
    }));

    return function getRepositoryIssueStatusDao(_x7, _x8) {
 ...
 * 获取仓库的提交列表
 */
var getReposCommitsDao = function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee5(userName, reposName, page) {
        var url, res;
        return _regenerator2.default.wrap(function _callee5$(_context5) {
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        url = _address2.default.getReposCommits(userName, reposName) + _address2.default.getPageParams("?", page);
                        _context5.next = 3;
                        return _api2.default.netFetch(url);
    ...
    return function getReposCommitsDao(_x9, _x10, _x11) {
 ...
 */
var getRepositoryIssueDao = function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee6() {
        ...
        var direction = arguments[5];
        var url, res;
        return _regenerator2.default.wrap(function _callee6$(_context6) {
            while (1) {
                switch (_context6.prev = _context6.next) {
                    case 0:
                        url = _address2.default.getReposIssue(userName, repository, state, sort, direction) + _address2.default.getPageParams("&", page);
                        _context6.next = 3;
                        return _api2.default.netFetch(url, 'GET', null, false, { Accept: 'application/vnd.github.html,application/vnd.github.VERSION.raw' });
    ...
    return function getRepositoryIssueDao() {
 ...
 */
var searchRepositoryIssueDao = function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee7(q, name, reposName) {
            ...
            while (1) {
                switch (_context7.prev = _context7.next) {
                    case 0:
                        ...
                        url = _address2.default.repositoryIssueSearch(qu) + _address2.default.getPageParams("&", page);
                        _context7.next = 5;
                        return _api2.default.netFetch(url);
    ...
    return function searchRepositoryIssueDao(_x13, _x14, _x15) {
 ...
 * 获取仓库的文件列表
 */
var getReposFileDirDao = function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee8(userName, reposName) {
        var path = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
        var branch = arguments[3];
        var type = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'json';
        var url, res, dir, file, data;
        return _regenerator2.default.wrap(function _callee8$(_context8) {
            while (1) {
                switch (_context8.prev = _context8.next) {
                    case 0:
                        url = _address2.default.reposDataDir(userName, reposName, path, branch);
                        _context8.next = 3;
                        return _api2.default.netFetch(url, 'GET', null, false, { Accept: 'application/vnd.github.html' }, type);
    ...
    return function getReposFileDirDao(_x17, _x18) {
        return _ref8.apply(this, arguments);
    };
}();

exports.default = {
    getTrendDao: getTrendDao,
    getRepositoryDetailReadmeHtmlDao: getRepositoryDetailReadmeHtmlDao,
    getRepositoryDetailDao: getRepositoryDetailDao,
    getReposCommitsDao: getReposCommitsDao,
    getRepositoryIssueDao: getRepositoryIssueDao,
    searchRepositoryIssueDao: searchRepositoryIssueDao,
    getReposFileDirDao: getReposFileDirDao
};
...
exports.isImageEnd = exports.formName = exports.generateCode2HTml = exports.generateHtml = undefined;
...
var generateHtml = exports.generateHtml = function generateHtml(mdData) {
    var backgroundColor = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "#FFFFFF";
    var userBR = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;

    if (!mdData) {
        return "";
    }
    var mdDataCode = mdData.replace(/<code(([\s\S])*?)<\/code>/gi, function (match, capture) {
        if (match) {
    ...
    mdDataCode = mdDataCode.replace(/<pre>(([\s\S])*?)<\/pre>/gi, function (match, capture) {
        if (match && capture) {
            if (match.indexOf("<code>") < 0) {
                var code = "<pre><code>" + capture + "</code></pre>";
                if (code.indexOf("\n") !== -1) {
                    code = code.replace(/[\n]/g, '\n\r<br>');
                }
                return code;
    ...
    var data = mdDataCode.replace(/href="(.*?)"/gi, function (match, capture) {
        if (match && capture) {
            if (capture.indexOf("http://") < 0 && capture.indexOf("https://") < 0 && capture.indexOf("#") !== 0) {
                var fixedUrl = "gsygithub://" + capture;
                var href = "href=\"" + fixedUrl + "\"";
                return href;
            }
            return match;
        } else {
 ...
 * style for mdHTml
 */
var generateCodeHtml = function generateCodeHtml(mdHTML, wrap) {
    var backgroundColor = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Constant.white;
    var actionColor = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : Constant.actionBlue;
    var userBR = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;

    var doc = "<html>\n" + "<head>\n" + "<meta charset=\"utf-8\" />\n" + "<title></title>\n" + "<meta name=\"viewport\" content=\"width=device-width; initial-scale=1.0; maximum-scale=1.0; user-scalable=0;\"/>" + "<link href=\"https:\/\/cdn.bootcss.com/highlight.js/9.12.0/styles/dracula.min.css\" rel=\"stylesheet\">\n" + "<script src=\"https:\/\/cdn.bootcss.com/highlight.js/9.12.0/highlight.min.js\"></script>  " + "<script>hljs.configure({'useBR': " + userBR + "});hljs.initHighlightingOnLoad();</script> " + "<style>" + "body{background: " + backgroundColor + ";}" + "a {color:" + actionColor + " !important;}" + ".highlight pre, pre {" + " word-wrap: " + (wrap ? "break-word" : "normal") + "; " + " white-space: " + (wrap ? "pre-wrap" : "pre") + "; " + "}" + "thead, tr {" + "background:" + Constant.miWhite + ";}" + "td, th {" + "padding: 5px 10px;" + "font-size: 12px;" + "direction:hor" + "}" + ".highlight {overflow: scroll; background: " + Constant.webDraculaBackgroundColor + "}" + "tr:nth-child(even) {" + "background:" + Constant.primaryLightColor + ";" + "color:" + Constant.miWhite + ";" + "}" + "tr:nth-child(odd) {" + "background: " + Constant.miWhite + ";" + "color:" + Constant.primaryLightColor + ";" + "}" + "th {" + "font-size: 14px;" + "color:" + Constant.miWhite + ";" + "background:" + Constant.primaryLightColor + ";" + "}" + "</style>" + "</head>\n" + "<body>\n" + mdHTML + "</body>\n" + "</html>";
    return doc;
};

var generateCode2HTml = exports.generateCode2HTml = function generateCode2HTml(mdData) {
    var backgroundColor = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Constant.white;
    var lang = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'java';
    var userBR = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;

    var currentData = mdData && mdData.indexOf("<code>") === -1 ? "<body>\n" + "<pre class=\"pre\">\n" + ("<code lang='" + lang + "'>\n") + mdData + "</code>\n" + "</pre>\n" + "</body>\n" : "<body>\n" + "<pre class=\"pre\">\n" + mdData + "</pre>\n" + "</body>\n";
    return generateHtml(currentData, backgroundColor, userBR);
};

var formName = exports.formName = function formName(name) {
    switch (name) {
        case 'sh':
            return 'shell';
        case 'js':
...
var isImageEnd = exports.isImageEnd = function isImageEnd(path) {
    var image = false;
    IMAGE_END.forEach(function (item) {
...
var IMAGE_END = [".png", ".jpg", ".jpeg", ".gif", ".svg"];
...
var _TrendingUtil = __webpack_require__(385);

var _TrendingUtil2 = _interopRequireDefault(_TrendingUtil);
...
var _GitHubTrending = function () {
    function GitHubTrending() {
        _classCallCheck(this, GitHubTrending);
    }

    _createClass(GitHubTrending, [{
        key: 'GitHubTrending',
        value: function GitHubTrending() {
            //Singleton pattern
            if (_typeof(_GitHubTrending.instance) === 'object') {
                return _GitHubTrending.instance;
            }
            _GitHubTrending.instance = this;
        }
    }, {
        key: 'fetchTrending',
        value: function fetchTrending(nativeUrl, since, language) {
            var _this = this;
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this.fetch(url).then(function (response) {
                    ...
                    try {
                        resolve({ result: true, data: _TrendingUtil2.default.htmlToRepo(responseData) });
                    } catch (e) {
...
exports.default = _GitHubTrending;
...
var _TrendingRepoModel = __webpack_require__(386);

var _TrendingRepoModel2 = _interopRequireDefault(_TrendingRepoModel);

var _StringUtil = __webpack_require__(387);
...
var TrendingUtil = function () {
    function TrendingUtil() {
        _classCallCheck(this, TrendingUtil);
    }

    _createClass(TrendingUtil, null, [{
        key: 'htmlToRepo',
        value: function htmlToRepo(responseData) {
            ...
            for (var i = 0; i < splitWithH3.length; i++) {
                var repo = new _TrendingRepoModel2.default();
        ...
        key: 'parseContentWithNote',
        value: function parseContentWithNote(htmlStr, startFlag, endFlag) {
            ...
            return _StringUtil2.default.trim(content);
        }
    }, {
        key: 'parseRepoBaseInfo',
        value: function parseRepoBaseInfo(repo, htmlBaseInfo) {
        ...
        key: 'parseRepoLabelWithTag',
        value: function parseRepoLabelWithTag(repo, noteContent, tag) {
            ...
            var content = this.parseContentWithNote(noteContent, startFlag, tag.end);
            var metaContent = content.substring(content.indexOf('</svg>') + '</svg>'.length, content.length);
            return _StringUtil2.default.trim(metaContent);
        }
    }, {
        key: 'parseRepoLang',
        value: function parseRepoLang(repo, metaNoteContent) {
            var content = this.parseContentWithNote(metaNoteContent, 'programmingLanguage">', '</span>');
            repo.language = _StringUtil2.default.trim(content);
        }
    }, {
        key: 'parseRepoContributors',
        value: function parseRepoContributors(repo, htmlContributors) {
...
var TrendingRepoModel = function TrendingRepoModel(fullName, url, description, language, meta, contributors, contributorsUrl, starCount, forkCount, name, reposName) {
    _classCallCheck(this, TrendingRepoModel);
...
exports.default = TrendingRepoModel;
...
var _RLList = __webpack_require__(360);
...
exports.default = {
    props: {},
    components: { RLList: _RLList2.default },
    data: function data() {
        return {
            userName: "",
            reposName: "",
    ...
    methods: {
        ...
        loadDetail: function loadDetail() {
            ...
            _repository2.default.getRepositoryDetailDao(this.userName, this.reposName).then(function (res) {
                if (res && res.result) {
                    _this.reposInfo = res.data;
                }
            });
        },
        loadCommit: function loadCommit(type) {
            var _this2 = this;

            if (this.isPreparing()) {
                return;
            }
            _repository2.default.getReposCommitsDao(this.userName, this.reposName, this.currentPage).then(function (res) {
                _this2.resolveResult(res, type);
            });
        },
        loadEvent: function loadEvent(type) {
            var _this3 = this;

            if (this.isPreparing()) {
                return;
            }
            _event2.default.getRepositoryEventDao(this.currentPage, this.userName, this.reposName).then(function (res) {
                _this3.resolveResult(res, type);
            });
        },
        ...
        headerClick: function headerClick(type, index) {
            this.listType = index;
            this.onRefresh();
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    ref: "dylist",
    attrs: {
      "listItemName": "EventItem",
      "listData": _vm.eventList,
      "headerComponent": "RepositoryHeadItem",
      "headerData": _vm.reposInfo,
