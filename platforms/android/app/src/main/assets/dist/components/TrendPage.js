...
var _filterUtils = __webpack_require__(409);
...
exports.default = {
    components: { RLList: _RLList2.default, WxcButton: _weexUi.WxcButton, WxcPopover: _weexUi.WxcPopover },
    data: function data() {
        return {
            currentPage: 1,
            time: '今日',
    ...
    methods: {
        loadData: function loadData(type) {
            ...
            this.$store.dispatch('getTrend', {
                ...
                callback: function callback(res) {
                    ...
                    if (type === 1) {
                        if (_this.$refs.dylist) {
                            _this.$refs.dylist.stopRefresh();
                        }
                    }
                    if (_this.$refs.dylist) {
                        _this.$refs.dylist.setNotNeedLoadMore();
                    }
                }
            });
        },
        ...
        onDailyClick: function onDailyClick() {
        ...
        popoverDailyButtonClicked: function popoverDailyButtonClicked(obj) {
            this.time = _filterUtils.TrendTime[obj.index].text;
            this.since = _filterUtils.TrendTime[obj.index].key;
            this.onRefresh();
        },
        popoverLanguageButtonClicked: function popoverLanguageButtonClicked(obj) {
            this.language = _filterUtils.TrendType[obj.index].text;
            this.languageType = _filterUtils.TrendType[obj.index].key;
            this.onRefresh();
        }
    }
};
...
var TrendTime = exports.TrendTime = [{
    "key": 'daily', "text": '今天'
}, {
    "key": 'weekly', "text": '本周'
}, {
...
var TrendType = exports.TrendType = [{
    "key": null, "text": '全部'
}, {
    "key": 'Java', "text": 'Java'
}, {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    on: {
      "wxcButtonClicked": _vm.onDailyClick
    }
  })], 1), _c('div', {
    style: {
      width: '3px',
    ...
    on: {
      "wxcButtonClicked": _vm.onLanguageClick
    }
  })], 1), _c('wxc-popover', {
    ref: "wxc-popover1",
    attrs: {
      "buttons": _vm.btns1,
      "position": _vm.popoverPosition1,
      "arrowPosition": _vm.popoverArrowPosition1
    },
    on: {
      "wxcPopoverButtonClicked": _vm.popoverDailyButtonClicked
    }
  }), _c('wxc-popover', {
    ref: "wxc-popover2",
    attrs: {
    ...
    on: {
      "wxcPopoverButtonClicked": _vm.popoverLanguageButtonClicked
    }
  })], 1), _c('div', {
