...
exports.default = {
    ...
    methods: {
        ...
        loadData: function loadData() {
            ...
            this.loading = true;
            _repository2.default.getReposFileDirDao(this.userName, this.reposName, this.path, this.curBranch).then(function (res) {
                _this.resolveResult(res, 1);
                _this.loading = false;
            });
        },
        ...
        itemClick: function itemClick(index) {
            ...
            if (data.type === 'file') {
                if ((0, _htmlUtils.isImageEnd)(data.name)) {
                ...
                var path = headerList.slice(1, headerList.length).join("/");
                this.path = path;
                this.onRefresh();
            }
        },
        tabClick: function tabClick(index) {
            ...
            var headerList = this.headerList;
            if (headerList[index] !== ".") {
                var newHeaderList = headerList.slice(0, parseInt(index) + 1);
                var path = newHeaderList.slice(1, newHeaderList.length).join("/");
                this.path = path;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, _vm._l((_vm.headerList), function(v, index) {
    return _c('div', {
      key: index,
